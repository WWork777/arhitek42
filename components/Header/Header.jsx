...
export default function Header() {
  ...
  const reachMetrikaGoal = (goalName) => {
    if (typeof window !== "undefined" && typeof window.ym !== "undefined") {
      window.ym(98007197, "reachGoal", goalName);
    }
  };
        ...
        <div className="header-container">
          ...
          <div className="contacts-container">
            <div className="icons">
              {/* VK Goal */}
              <a
                href="https://vk.com/arhitek142"
                target="_blank"
                rel="noopener noreferrer"
                onClick={() => reachMetrikaGoal("VK")}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 64 64"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                onClick={() => reachMetrikaGoal("telegram")}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="40"
                  ...
                  fill="whitesmoke"
                >
                  <path d="M 32 10 C 19.85 10 10 19.85 10 32 C 10 44.15 19.85 54 32 54 C 44.15 54 54 44.15 54 32 C 54 19.85 44.15 10 32 10 z M 32 14 C 41.941 14 50 22.059 50 32 C 50 41.941 41.941 50 32 50 C 22.059 50 14 41.941 14 32 C 14 22.059 22.059 14 32 14 z"></path>
            ...
            <div className="tel">
              ...
              <a
                ...
                onClick={() => reachMetrikaGoal("phone")}
              >
                +7 (3842) 65-77-75
              </a>
            </div>
